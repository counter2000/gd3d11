...
XRESULT GothicAPI::SaveMenuSettings( const std::string& file ) {
    ...
    WritePrivateProfileStringA( "General", "EnableUnderwaterVolumeFog", std::to_string( s.EnableUnderwaterVolumeFog ? TRUE : FALSE ).c_str(), ini.c_str() );
    WritePrivateProfileStringA( "General", "EnableContactShadows", std::to_string( s.EnableContactShadows ? TRUE : FALSE ).c_str(), ini.c_str() );
    WritePrivateProfileStringA( "General", "ContactShadowStrength", std::to_string( s.ContactShadowStrength ).c_str(), ini.c_str() );
    WritePrivateProfileStringA( "General", "EnableSimpleSSGI", std::to_string( s.EnableSimpleSSGI ? TRUE : FALSE ).c_str(), ini.c_str() );
    WritePrivateProfileStringA( "General", "SimpleSSGIStrength", std::to_string( s.SimpleSSGIStrength ).c_str(), ini.c_str() );
    WritePrivateProfileStringA( "General", "EnableWetSurfaceReflections", std::to_string( s.EnableWetSurfaceReflections ? TRUE : FALSE ).c_str(), ini.c_str() );
...
XRESULT GothicAPI::LoadMenuSettings( const std::string& file ) {
    ...
    if ( Toolbox::FileExists( ini ) ) {
        ...
        s.EnableSoftParticles = GetPrivateProfileBoolA( "General", "EnableSoftParticles", defaultRendererSettings.EnableSoftParticles, ini );
        s.EnableUnderwaterVolumeFog = GetPrivateProfileBoolA( "General", "EnableUnderwaterVolumeFog", defaultRendererSettings.EnableUnderwaterVolumeFog, ini );
        s.EnableContactShadows = GetPrivateProfileBoolA( "General", "EnableContactShadows", defaultRendererSettings.EnableContactShadows, ini );
        s.ContactShadowStrength = GetPrivateProfileFloatA( "General", "ContactShadowStrength", defaultRendererSettings.ContactShadowStrength, ini.c_str() );
        s.EnableSimpleSSGI = GetPrivateProfileBoolA( "General", "EnableSimpleSSGI", defaultRendererSettings.EnableSimpleSSGI, ini );
        s.SimpleSSGIStrength = GetPrivateProfileFloatA( "General", "SimpleSSGIStrength", defaultRendererSettings.SimpleSSGIStrength, ini.c_str() );
        s.EnableWetSurfaceReflections = GetPrivateProfileBoolA( "General", "EnableWetSurfaceReflections", defaultRendererSettings.EnableWetSurfaceReflections, ini );
